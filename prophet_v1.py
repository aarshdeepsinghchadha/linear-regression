...
# Save forecasts
user_forecasts.to_csv(f'{output_folder}/csv_files/user_forecasts_2025_v5.csv', index=False)
project_forecasts.to_csv(f'{output_folder}/csv_files/project_forecasts_2025_v5.csv', index=False)

# --- Historical and Predicted Analysis ---

# Historical top users (2020-2024)
...
top_users_historical.to_csv(f'{output_folder}/csv_files/historical_top_users_2020_2024_v5.csv', index=False)
...
top_users_2025_pred.to_csv(f'{output_folder}/csv_files/predicted_top_users_2025_v5.csv', index=False)

# --- Graphing Section ---

# 1. Historical Top Users (2020-2024)
...
plt.title('Historical Top User Hours by Month (2020-2024)')
plt.xlabel('Month')
...
plt.tight_layout()
plt.savefig(f'{output_folder}/images/historical_top_users_2020_2024_v5.png')
plt.close()

# 2. Historical Total Project Hours (2020-2024)
...
for year in range(2020, 2025):
    ...
    plt.plot(year_data['month'], year_data['timelog'], label=str(year), marker='o')
plt.title('Historical Total Project Hours by Month (2020-2024)')
plt.xlabel('Month')
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(f'{output_folder}/images/historical_project_hours_2020_2024_v5.png')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(f'{output_folder}/images/predicted_top_users_2025_v5.png')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(f'{output_folder}/images/predicted_project_hours_2025_v5.png')
plt.close()

# --- Output Summary ---
print(f"\nCSVs saved in '{output_folder}/csv_files':")
print("  - user_forecasts_2025_v5.csv")
print("  - project_forecasts_2025_v5.csv")
print("  - historical_top_users_2020_2024_v5.csv")
print("  - predicted_top_users_2025_v5.csv")
print(f"Images saved in '{output_folder}/images':")
print("  - historical_top_users_2020_2024_v5.png")
print("  - historical_project_hours_2020_2024_v5.png")
print("  - predicted_top_users_2025_v5.png")
print("  - predicted_project_hours_2025_v5.png")