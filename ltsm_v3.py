...
output_dir = os.path.join(root_dir, 'data', 'output', 'v3')  # Updated to v3
csv_folder = os.path.join(output_dir, 'csv_files')
image_folder = os.path.join(output_dir, 'images')
os.makedirs(csv_folder, exist_ok=True)
os.makedirs(image_folder, exist_ok=True)

# Load data from v3 folder
timelogs = pd.read_csv(os.path.join(root_dir, 'data', 'v3', 'user_timelogs_v3.csv'))  # Updated to v3
...
# Save forecasts with new v3 file names
user_forecasts.to_csv(os.path.join(csv_folder, 'user_forecasts_2025_lstm_v3.csv'), index=False)
project_forecasts.to_csv(os.path.join(csv_folder, 'project_forecasts_2025_lstm_v3.csv'), index=False)
...
top_users_historical.to_csv(os.path.join(csv_folder, 'historical_top_users_2010_2024_lstm_v3.csv'), index=False)
...
top_users_2025_pred.to_csv(os.path.join(csv_folder, 'predicted_top_users_2025_lstm_v3.csv'), index=False)
...
plt.tight_layout()
plt.savefig(os.path.join(image_folder, 'historical_top_users_2010_2024_lstm_v3.png'), bbox_inches='tight')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(image_folder, 'historical_project_hours_2010_2024_lstm_v3.png'), bbox_inches='tight')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(image_folder, 'predicted_top_users_2025_lstm_v3.png'))
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(os.path.join(image_folder, 'predicted_project_hours_2025_lstm_v3.png'))
plt.close()

# --- Output Summary ---
print(f"\nCSVs saved in '{csv_folder}':")
print("  - user_forecasts_2025_lstm_v3.csv")
print("  - project_forecasts_2025_lstm_v3.csv")
print("  - historical_top_users_2010_2024_lstm_v3.csv")
print("  - predicted_top_users_2025_lstm_v3.csv")
print(f"Images saved in '{image_folder}':")
print("  - historical_top_users_2010_2024_lstm_v3.png")
print("  - historical_project_hours_2010_2024_lstm_v3.png")
print("  - predicted_top_users_2025_lstm_v3.png")
print("  - predicted_project_hours_2025_lstm_v3.png")