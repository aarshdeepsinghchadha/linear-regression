...
# Save forecasts
user_forecasts.to_csv(f'{output_folder}/csv_files/user_forecasts_2025_v8.1.csv', index=False)
project_forecasts.to_csv(f'{output_folder}/csv_files/project_forecasts_2025_v8.1.csv', index=False)
...
top_users_historical.to_csv(f'{output_folder}/csv_files/historical_top_users_2010_2024_v8.1.csv', index=False)
...
top_users_2025_pred.to_csv(f'{output_folder}/csv_files/predicted_top_users_2025_v8.1.csv', index=False)
...
plt.tight_layout()
plt.savefig(f'{output_folder}/images/historical_top_users_2010_2024_v8.1.png')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(f'{output_folder}/images/historical_project_hours_2010_2024_v8.1.png')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(f'{output_folder}/images/predicted_top_users_2025_v8.1.png')
plt.close()
...
plt.xticks(rotation=45)
plt.tight_layout()
plt.savefig(f'{output_folder}/images/predicted_project_hours_2025_v8.1.png')
plt.close()

# Output Summary
print(f"\nCSVs saved in '{output_folder}/csv_files':")
print("  - user_forecasts_2025_v8.1.csv")
print("  - project_forecasts_2025_v8.1.csv")
print("  - historical_top_users_2010_2024_v8.1.csv")
print("  - predicted_top_users_2025_v8.1.csv")
print(f"Images saved in '{output_folder}/images':")
print("  - historical_top_users_2010_2024_v8.1.png")
print("  - historical_project_hours_2010_2024_v8.1.png")
print("  - predicted_top_users_2025_v8.1.png")
print("  - predicted_project_hours_2025_v8.1.png")